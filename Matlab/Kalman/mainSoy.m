...
% dataPanel=[1]./12;
% ttmInd = ttm >= 0 & ttm <= dataPanel(end);
% yData=filledPrices(dateInd,ttmInd);
% panel=ttm(ttmInd)';
...
[logL,ss_att]=kalmanFilter(P0,a0,c,T,varEta,dtau,Ztau,varEpsMode,yData(2:end,indContracts));
